	...
	exports.TeambuilderRoom = exports.Room.extend({
		...
		setPokemon: function (val, selectNext) {
			...
			if (this.curTeam && this.curTeam.format) {
				...
				if (this.curTeam && this.curTeam.format) {
					set.level = 120;
					if (baseFormat.includes('flatrules') || 
						baseFormat.substr(0, 10) === 'battlespot' && baseFormat.substr(0, 19) !== 'battlespotspecial13' ||
						baseFormat.substr(0, 3) === 'vgc' || baseFormat.substr(0, 14) === 'battlefestival') set.level = 50;
					if (baseFormat.includes('littlecup') ||
						baseFormat.substr(0, 2) === 'lc' || baseFormat.substr(0, 5) === 'caplc' || baseFormat.substr(-2) === 'lc') set.level = 5;
