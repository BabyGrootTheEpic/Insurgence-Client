...
export class PokemonSprite extends Sprite {
	...
	protected static statusTable: {[id: string]: [string, 'good' | 'bad' | 'neutral'] | null | string} = {
		...
		wrap: ['Wrap', 'bad'],
		// Splinters
		splinters: ['Splinters', 'bad'],
		splintersnormal: ['Splinters', 'bad'],
		splintersfire: ['Splinters', 'bad'],
		splinterswater: ['Splinters', 'bad'],
		splinterselectric: ['Splinters', 'bad'],
		splintersgrass: ['Splinters', 'bad'],
		splintersice: ['Splinters', 'bad'],
		splintersfighting: ['Splinters', 'bad'],
		splinterspoison: ['Splinters', 'bad'],
		splintersground: ['Splinters', 'bad'],
		splintersflying: ['Splinters', 'bad'],
		splinterspsychic: ['Splinters', 'bad'],
		splintersbug: ['Splinters', 'bad'],
		splintersrock: ['Splinters', 'bad'],
		splintersghost: ['Splinters', 'bad'],
		splintersdragon: ['Splinters', 'bad'],
		splintersdark: ['Splinters', 'bad'],
		splinterssteel: ['Splinters', 'bad'],
		splintersfairy: ['Splinters', 'bad'],
		splinterscrystal: ['Splinters', 'bad'],
		splintersshadow: ['Splinters', 'bad'],
		// Gen 1-2
		mist: ['Mist', 'good'],
		// Gen 1
